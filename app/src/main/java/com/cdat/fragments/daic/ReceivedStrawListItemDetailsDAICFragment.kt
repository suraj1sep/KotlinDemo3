 ...
 */
class ReceivedStrawListItemDetailsDAICFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view = inflater.inflate(R.layout.fragment_straw_received_list_item_details_daic, container, false)
