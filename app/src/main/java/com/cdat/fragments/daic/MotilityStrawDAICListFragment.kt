...
class MotilityStrawDAICListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: MotilityStrawDIACListAdapter.ManageCart
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        fab_add.setOnClickListener {
            val registerFragment = MotilityStrawDAICFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "2")
        }

        manageCart = object : MotilityStrawDIACListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = MotilityStrawDIACListAdapter(this!!.activity!!, categoryList, manageCart)
