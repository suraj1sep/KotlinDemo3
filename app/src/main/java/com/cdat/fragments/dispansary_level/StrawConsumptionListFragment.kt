...
import com.cdat.adapter.dispansary_level.StrawConsumptionListAdapter
import com.cdat.helper.Config


class StrawConsumptionListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: StrawConsumptionListAdapter.ManageCart
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "Straw Consumption List"
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        fab_add.setOnClickListener {
            val registerFragment = StrawConsumptionDispensaryFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "2")
        }

        manageCart = object : StrawConsumptionListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = StrawConsumptionListAdapter(this!!.activity!!, categoryList, manageCart)
