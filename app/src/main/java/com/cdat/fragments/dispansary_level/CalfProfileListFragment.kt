...
import com.cdat.adapter.dispansary_level.CalfProfileListAdapter
import com.cdat.helper.Config


class CalfProfileListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: CalfProfileListAdapter.ManageCart
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "Calf Profile List"
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        fab_add.setOnClickListener {
            val registerFragment = CalfProfileDispensaryFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "2")
        }

        manageCart = object : CalfProfileListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = CalfProfileListAdapter(this!!.activity!!, categoryList, manageCart)
