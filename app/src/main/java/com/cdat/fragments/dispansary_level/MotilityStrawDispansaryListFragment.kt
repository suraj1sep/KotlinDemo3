...
class MotilityStrawDispansaryListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: MotilityStrawDispansaryListAdapter.ManageCart
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "Motility Straw List"
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        var view = inflater.inflate(R.layout.fragment_motility_straw_diac_list, container, false)
        ...
        fab_add.setOnClickListener {
            val registerFragment = MotilityStrawDispensaryFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "2")
        }

        manageCart = object : MotilityStrawDispansaryListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = MotilityStrawDispansaryListAdapter(this!!.activity!!, categoryList, manageCart)
