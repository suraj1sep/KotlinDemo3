...
class MotilityStrawDispansaryListAdapter(private val context: FragmentActivity, private val productList: ArrayList<String>, clickListener: ManageCart)
    : RecyclerView.Adapter<MotilityStrawDispansaryListAdapter.ViewHolder>(), Filterable {
