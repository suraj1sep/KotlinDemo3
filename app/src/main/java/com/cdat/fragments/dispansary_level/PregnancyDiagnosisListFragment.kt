...
import com.cdat.adapter.dispansary_level.PregnancyDiagnosisListAdapter
import com.cdat.helper.Config


class PregnancyDiagnosisListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: PregnancyDiagnosisListAdapter.ManageCart
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "Pregnancy Diagnosis List"
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        var view = inflater.inflate(R.layout.fragment_straw_consumption_list, container, false)
        ...
        fab_add.setOnClickListener {
            val registerFragment = PregnancyDiagnosisDispensaryFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "2")
        }

        manageCart = object : PregnancyDiagnosisListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = PregnancyDiagnosisListAdapter(this!!.activity!!, categoryList, manageCart)
