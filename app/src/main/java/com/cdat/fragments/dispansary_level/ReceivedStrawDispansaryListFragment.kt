...
import com.cdat.R
import com.cdat.adapter.dispansary_level.ReceivedStrawDispansaryListAdapter
import com.cdat.helper.Config


class ReceivedStrawDispansaryListFragment : Fragment() {

    companion object {
        private lateinit var recyclerView: RecyclerView
        private lateinit var et_search: EditText
        private val categoryList: ArrayList<String> = ArrayList()
        lateinit var manageCart: ReceivedStrawDispansaryListAdapter.ManageCart
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view = inflater.inflate(R.layout.fragment_received_straw_dispansary, container, false)
        ...
        fab_add.setOnClickListener {
            val registerFragment = ReceivedStrawDispansaryFragment()
        ...
        var adapter1 = ReceivedStrawDispansaryListAdapter(this!!.activity!!, categoryList, manageCart)
