 ...
 */
class PregnancyDiagnosisDispensaryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "Pregnancy Diagnosis "
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        var view = inflater.inflate(R.layout.fragment_pregnacy_diagnosis, container, false)
        ...
        tv_animal_cate = view.findViewById<TextView>(R.id.tv_animal_cate) as TextView
        tv_animal_breed_category = view.findViewById<TextView>(R.id.tv_animal_breed_category) as TextView
        tv_breed_blood_level = view.findViewById<TextView>(R.id.tv_breed_blood_level) as TextView
        tv_pd_tested_date = view.findViewById<TextView>(R.id.tv_pd_tested_date) as TextView
        tv_date_calving = view.findViewById<TextView>(R.id.tv_date_calving) as TextView
        ...
        tv_pd_tested_date.setOnClickListener {
            ...
            val datePickerDialog = DatePickerDialog(activity!!,
                    DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                        ...
                        tv_pd_tested_date.text = (day + "/" + month + "/" + year)
                    }, mYear, mMonth, mDay)
