...
import com.cdat.adapter.lab.StrawPurchaseListAdapter
 ...
 */
class StrawPurchaseLabListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: StrawPurchaseListAdapter.ManageCart
        public var searchText: String = ""
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        (activity as AppCompatActivity).supportActionBar!!.title = "STRAW Purchase List"
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        fab_add.setOnClickListener {
            val registerFragment = StrawPurchaseAddFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "ankole")
        }

        manageCart = object : StrawPurchaseListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = StrawPurchaseListAdapter(this!!.activity!!, categoryList, manageCart)
