...
import com.cdat.adapter.AnimalProfileListAdapter
import com.cdat.helper.Config

class AnimalProfileListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: AnimalProfileListAdapter.ManageCart
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as AppCompatActivity).supportActionBar!!.title = "Animal Profile List"
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        var view = inflater.inflate(R.layout.fragment_animal_profile_list, container, false)
        ...
        fab_add.setOnClickListener {
            val registerFragment = AnimalProfileFragment()
            Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "2")
        }

        manageCart = object : AnimalProfileListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = AnimalProfileListAdapter(this!!.activity!!, categoryList, manageCart)
