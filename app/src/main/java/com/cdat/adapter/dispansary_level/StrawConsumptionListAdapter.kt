...
class StrawConsumptionListAdapter(private val context: FragmentActivity, private val productList: ArrayList<String>, clickListener: ManageCart)
    : RecyclerView.Adapter<StrawConsumptionListAdapter.ViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_straw_consumption, parent, false)
...
//            holder.tv_product_name.text = highlightText(BullListFragment.searchText, mFilteredList.get(position))
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var tv_buildIdNo: TextView = itemView.findViewById<TextView>(R.id.tv_buildIdNo) as TextView
        var tv_batchNo: TextView = itemView.findViewById<TextView>(R.id.tv_batchNo) as TextView
        var tv_strawNo: TextView = itemView.findViewById<TextView>(R.id.tv_strawNo) as TextView
        var tv_timeAl: TextView = itemView.findViewById<TextView>(R.id.tv_timeAl) as TextView
