...
import com.dairy.R
import com.dairy.adapter.BullListAdapter
import android.support.v7.app.AppCompatActivity
import com.dairy.adapter.ProductionListAdapter
 ...
 */
class ProductionLabListFragment : Fragment() {
    ...
    companion object {
        ...
        lateinit var manageCart: ProductionListAdapter.ManageCart
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        fab_add.setOnClickListener {
            val registerFragment = ProductionAddFragment()
           // Config.slideFragment(registerFragment, "", fragmentManager!!, R.id.content_frame, "ankole")
        }

        manageCart = object : ProductionListAdapter.ManageCart {
            override fun cart() {
        ...
        var adapter1 = ProductionListAdapter(this!!.activity!!, categoryList, manageCart)
